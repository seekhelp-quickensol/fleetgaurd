...
<!-- 
 ...
 -->
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active fade-in " id="main-table" role="tabpanel">
                ...
                <?php if ($this->uri->segment(2) != '') { ?>
                    ...
                    <h6 class="table-title mb-3">Update Department</h2>

                    <?php } else { ?>

                        <h6 class="table-title mb-3">Add Department</h2>

                        <?php } ?>

                        <div class="form-data mb-4">

                            <form method="post" name="add_department" id="add_department" enctype="multipart/form-data">
                                ...
                                <div class="row flex_wrap">
                                    ...
                                    <div class="form-group col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" name="department_name"

                                            id="department_name" value="<?php if (!empty($single)) {

                                                                            echo $single->department_name;

                                                                        } ?>" placeholder="Enter department name">



                                        <span id="department_name_error" class="error-message"></span>
                        ...
                        <h6 class="mb-3">Department List</h6>

                        <div class="list-data">

                            <div class="">

                                <div class="department-list mt-1 p-2"></div>
    ...
    <script>
        ...
        var table = new Tabulator(".department-list", {
            ...
            ajaxURL: "<?= base_url() ?>admin/Ajax_controller/get_all_department_list_ajax",
            ...
            columns: [{
...

                {
                    ...
                    headerFilterPlaceholder: "Search By Department Name"
...

                {
                    ...
                    formatter: function(cell, formatterParams) {
                      ...
                      href="<?= base_url('inactive/tbl_department/') ?>${id}"
                      ...
                      href="<?= base_url('active/tbl_department/') ?>${id}"
                  ...
                  href="<?= base_url('delete/tbl_department/') ?>${id}"
                  ...
                  href="<?php echo base_url('deparment-management/'); ?>${id}">
            ...
            $("#add_department").validate({
                ...
                messages: {
                    ...
                    department_name: {
                        ...
                        noSpaceStart: "Please enter the valid department name !",
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == 1) {
                        ...
                        $('#department_name_error').text("This department name is already added !");
