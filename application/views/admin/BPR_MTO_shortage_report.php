    ...
    <div class="sub-content">
        ...
        <div class="tab-content mt-3" id="myTabContent">
            ...
            <div class="tab-pane fade show active fade-in " id="main-table" role="tabpanel">
                ...
                <h6 class="mb-3">BPR MTO Shortage Report</h6>
                <div class="list-data">
                        ...
                        <table class="table table-striped table-bordered">
							<thead>
								<tr>
									...
									<th>Pending Order Quantity</th>
									<th>Plant On-Hand Quantity</th>
									<th class="bg-green">Full Kit Quantity</th>
									...
									<th class="bg-green">Description</th>
							...
							<tbody>
								<?php if (!empty($report_data)) {
									...
									foreach ($report_data as $report_result) { ?>
										<tr>
											<td><?= $i++; ?></td>
											<td><?= $report_result->sales_order_number; ?></td>
											<td><?= $report_result->category_code; ?></td>
											<td><?= $report_result->ff_part_no; ?></td>
											<td><?= $report_result->ff_part_description; ?></td>
											<td><?= $report_result->customer_part_no; ?></td>
											<td><?= $report_result->need_by_date; ?></td>
											<td><?= $report_result->order_quantity; ?></td>
											<td><?= $report_result->pending_order_quantity; ?></td>
											<td><?= $report_result->plant_on_hand_quantity; ?></td>
											...
											<td>
												<button class="btn btn-sm btn-outline-dark edit" title="Edit"
														data-bs-toggle="modal" data-bs-target="#planQtyModal" onclick="openPlanQtyUpdate('<?=$report_result->report_id;?>', '<?=$report_result->pending_order_quantity;?>', '<?=$report_result->ff_part_no;?>')">
