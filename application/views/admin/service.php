                ...
                <div class="form-data mb-4">
                    <div class="row flex_wrap">
                        <div class="form-group col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            ...
                            <input autocomplete="off" type="text" class="form-control" name="type_name"
                                id="type_name" value="" placeholder="Enter type of good">
